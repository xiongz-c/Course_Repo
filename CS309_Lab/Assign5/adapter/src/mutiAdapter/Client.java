...
public class Client {
    public static void main( String[] args ) {
        ...
        ManageStaff adaptee2 = new ManageStaff();
        FileOperateInterfaceV2 fileOperator = new Adapter( adaptee,adaptee2 );
        Scanner input = new Scanner( System.in );
        System.out.println( "Please select operation: 1.readFile 2.listFile3.writeByName 4.writeByRoom 5.addNewStaff 6.removeStaffByName:" );
        int op = 0;
        do {
            try {
                op = input.nextInt( );
