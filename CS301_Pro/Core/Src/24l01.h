...
#define NRF24L01_CE_HEIGH() HAL_GPIO_WritePin(CE_GPIO_Port, CE_Pin, GPIO_PIN_SET)
#define NRF24L01_CSN_LOW() HAL_GPIO_WritePin(CSN_GPIO_Port, CSN_Pin, GPIO_PIN_RESET)
#define NRF24L01_CSN_HEIGH() HAL_GPIO_WritePin(CSN_GPIO_Port, CSN_Pin, GPIO_PIN_SET)
#define NRF24L01_IRQ    HAL_GPIO_ReadPin(IRQ_GPIO_Port,IRQ_Pin)   //IRQ������������
...
void NRF24L01_RX_Mode(int);//����Ϊ����ģʽ
void NRF24L01_TX_Mode(int);//����Ϊ����ģʽ
